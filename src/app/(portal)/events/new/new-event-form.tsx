  ...
  return (
    <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <textarea
          rows={4}
          className="w-full rounded-[1.5rem] border border-zinc-300 bg-white px-4 py-3 dark:border-zinc-700 dark:bg-zinc-900"
      ...
      <div className="rounded-[1.75rem] border border-zinc-200 bg-zinc-50/70 p-4 dark:border-zinc-800 dark:bg-zinc-950/50">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="w-fit text-xs font-semibold text-navy hover:underline"
          >
