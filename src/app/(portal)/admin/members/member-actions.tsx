...
export function MemberActions({
  ...
  return (
    <div className="min-w-56 space-y-3">
        ...
        {status === "pending" && (
          ...
          >
            <button
              ...
              className="min-h-9 rounded-full bg-navy px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-navy-dark disabled:opacity-50"
            >
        ...
        {status === "approved" && (
          ...
          >
            <button
              ...
              aria-describedby={feedbackId}
              disabled={pendingAction !== null}
              className="min-h-9 rounded-full border border-red-300 px-3 py-1.5 text-xs font-semibold text-red-700 transition-colors hover:bg-red-50 disabled:opacity-50 dark:border-red-900 dark:text-red-300 dark:hover:bg-red-950"
            >
      ...
      <form onSubmit={submitRoleChange} className="flex flex-col gap-2 sm:flex-row sm:items-end">
        <div className="space-y-1">
          ...
          <select
            ...
            disabled={pendingAction !== null}
            className="min-h-10 rounded-2xl border border-zinc-300 bg-white px-3 py-2 text-xs dark:border-zinc-700 dark:bg-zinc-900"
          >
        ...
        <button
          ...
          className="min-h-10 rounded-full border border-zinc-300 px-4 py-2 text-xs font-semibold hover:bg-zinc-50 disabled:opacity-50 dark:border-zinc-700 dark:hover:bg-zinc-900"
        >
