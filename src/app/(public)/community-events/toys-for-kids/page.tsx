...
export default function ToysForKidsPage() {
  return (
    <div className="bg-white px-6 py-16 sm:px-8 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-md border border-zinc-200 bg-[#f8f9fc] p-8 shadow-sm sm:p-10">
        <h1 className="text-4xl font-bold text-[#013594] sm:text-5xl">Toys for Kids</h1>
        <p className="mt-4 text-[15px] leading-8 text-zinc-700">
          Toys for Kids is our seasonal holiday outreach focused on giving children joyful support and practical resources.
        </p>
